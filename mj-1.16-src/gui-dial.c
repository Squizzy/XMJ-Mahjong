/* $Header: /home/jcb/MahJong/newmj/RCS/gui-dial.c,v 12.15 2020/05/16 15:46:02 jcb Exp $
 * gui-dial.c
...
static const char rcs_id[] = "$Header: /home/jcb/MahJong/newmj/RCS/gui-dial.c,v 12.15 2020/05/16 15:46:02 jcb Exp $";
...
/* checkbox for rotatelabels */
static GtkWidget *display_option_dialog_rotatelabels;
/* checkbox for thinking_claim */
static GtkWidget *display_option_dialog_thinking_claim;
/* checkbox for alert_mahjong */
static GtkWidget *display_option_dialog_alert_mahjong;
...
static void display_option_dialog_init(void) {
  ...
  /* rotatelabels */
  display_option_dialog_rotatelabels = but1 = 
    gtk_check_button_new_with_label("Rotate player info text");
  gtk_widget_show(but1);
  gtk_box_pack_start(GTK_BOX(box),but1,0,0,0);

  /* thinking_claim */
  display_option_dialog_thinking_claim = but1 = 
    gtk_check_button_new_with_label("Show when players are thinking");
  gtk_widget_show(but1);
  gtk_box_pack_start(GTK_BOX(box),but1,0,0,0);

  /* mah-jong */
  display_option_dialog_alert_mahjong = but1 = 
    gtk_check_button_new_with_label("Alert on possible mah-jong");
  gtk_widget_show(but1);
  gtk_box_pack_start(GTK_BOX(box),but1,0,0,0);
...
static void display_option_dialog_refresh(void) {
  ...
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(display_option_dialog_rotatelabels),rotatelabels);
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(display_option_dialog_thinking_claim),thinking_claim);
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(display_option_dialog_alert_mahjong),alert_mahjong);
...
static void display_option_dialog_apply(void) {
  ...
  int old_rotatelabels = rotatelabels;
  rotatelabels = GTK_TOGGLE_BUTTON(display_option_dialog_rotatelabels)->active;
  if ( old_rotatelabels != rotatelabels ) {
    gtk_label_set_angle(pdisps[3].infolab, rotatelabels ? 270 : 0);
    gtk_label_set_angle(pdisps[1].infolab, rotatelabels ? 90 : 0);
  }
  thinking_claim =  GTK_TOGGLE_BUTTON(display_option_dialog_thinking_claim)->active;
  alert_mahjong =  GTK_TOGGLE_BUTTON(display_option_dialog_alert_mahjong)->active;
